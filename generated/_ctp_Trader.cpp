...
static PyObject* create_TraderApi(PyObject* self, PyObject *args)
{
  ...
  void *p = CThostFtdcTraderApi::CreateFtdcTraderApi(flowpath);
  return PyLong_FromLong((long)p);
}


static PyObject* Trader_ReqQryInstrument(PyObject * self, PyObject * args){
  CThostFtdcTraderApi * user = (CThostFtdcTraderApi *) PyLong_AsLong(PyTuple_GET_ITEM(args, 0));
...
static PyObject* Trader_ReqAuthenticate(PyObject * self, PyObject * args){
  CThostFtdcTraderApi * user = (CThostFtdcTraderApi *) PyLong_AsLong(PyTuple_GET_ITEM(args, 0));
  PyObject * py_pReqAuthenticate = PyTuple_GET_ITEM(args, 1);
  CThostFtdcReqAuthenticateField* pReqAuthenticate = from_CThostFtdcReqAuthenticateField(py_pReqAuthenticate);
  PyObject * py_nRequestID = PyTuple_GET_ITEM(args, 2);
  int nRequestID = PyLong_AsLong(py_nRequestID);
  PyObject * ret = Py_BuildValue("i", user->ReqAuthenticate(pReqAuthenticate, nRequestID));
  free(pReqAuthenticate);
  return ret;
}
...
static PyObject* Trader_ReqQryInvestorProductGroupMargin(PyObject * self, PyObject * args){
  CThostFtdcTraderApi * user = (CThostFtdcTraderApi *) PyLong_AsLong(PyTuple_GET_ITEM(args, 0));
  PyObject * py_pQryInvestorProductGroupMargin = PyTuple_GET_ITEM(args, 1);
  CThostFtdcQryInvestorProductGroupMarginField* pQryInvestorProductGroupMargin = from_CThostFtdcQryInvestorProductGroupMarginField(py_pQryInvestorProductGroupMargin);
  PyObject * py_nRequestID = PyTuple_GET_ITEM(args, 2);
  int nRequestID = PyLong_AsLong(py_nRequestID);
  PyObject * ret = Py_BuildValue("i", user->ReqQryInvestorProductGroupMargin(pQryInvestorProductGroupMargin, nRequestID));
  free(pQryInvestorProductGroupMargin);
  return ret;
}
...
static PyObject* Trader_ReqQryExchangeRate(PyObject * self, PyObject * args){
  CThostFtdcTraderApi * user = (CThostFtdcTraderApi *) PyLong_AsLong(PyTuple_GET_ITEM(args, 0));
  PyObject * py_pQryExchangeRate = PyTuple_GET_ITEM(args, 1);
  CThostFtdcQryExchangeRateField* pQryExchangeRate = from_CThostFtdcQryExchangeRateField(py_pQryExchangeRate);
  PyObject * py_nRequestID = PyTuple_GET_ITEM(args, 2);
  int nRequestID = PyLong_AsLong(py_nRequestID);
  PyObject * ret = Py_BuildValue("i", user->ReqQryExchangeRate(pQryExchangeRate, nRequestID));
  free(pQryExchangeRate);
  return ret;
}
...
static PyObject* Trader_SubscribePublicTopic(PyObject * self, PyObject * args){
  ...
  THOST_TE_RESUME_TYPE nResumeType = (THOST_TE_RESUME_TYPE)PyLong_AsLong(py_nResumeType);
...
static PyObject* Trader_ReqQryExchangeMarginRate(PyObject * self, PyObject * args){
  CThostFtdcTraderApi * user = (CThostFtdcTraderApi *) PyLong_AsLong(PyTuple_GET_ITEM(args, 0));
  PyObject * py_pQryExchangeMarginRate = PyTuple_GET_ITEM(args, 1);
  CThostFtdcQryExchangeMarginRateField* pQryExchangeMarginRate = from_CThostFtdcQryExchangeMarginRateField(py_pQryExchangeMarginRate);
  PyObject * py_nRequestID = PyTuple_GET_ITEM(args, 2);
  int nRequestID = PyLong_AsLong(py_nRequestID);
  PyObject * ret = Py_BuildValue("i", user->ReqQryExchangeMarginRate(pQryExchangeMarginRate, nRequestID));
  free(pQryExchangeMarginRate);
  return ret;
}

static PyObject* Trader_ReqQryProduct(PyObject * self, PyObject * args){
  CThostFtdcTraderApi * user = (CThostFtdcTraderApi *) PyLong_AsLong(PyTuple_GET_ITEM(args, 0));
  PyObject * py_pQryProduct = PyTuple_GET_ITEM(args, 1);
  CThostFtdcQryProductField* pQryProduct = from_CThostFtdcQryProductField(py_pQryProduct);
  PyObject * py_nRequestID = PyTuple_GET_ITEM(args, 2);
  int nRequestID = PyLong_AsLong(py_nRequestID);
  PyObject * ret = Py_BuildValue("i", user->ReqQryProduct(pQryProduct, nRequestID));
  free(pQryProduct);
  return ret;
}
...
static PyObject* Trader_ReqQryExchangeMarginRateAdjust(PyObject * self, PyObject * args){
  CThostFtdcTraderApi * user = (CThostFtdcTraderApi *) PyLong_AsLong(PyTuple_GET_ITEM(args, 0));
  PyObject * py_pQryExchangeMarginRateAdjust = PyTuple_GET_ITEM(args, 1);
  CThostFtdcQryExchangeMarginRateAdjustField* pQryExchangeMarginRateAdjust = from_CThostFtdcQryExchangeMarginRateAdjustField(py_pQryExchangeMarginRateAdjust);
  PyObject * py_nRequestID = PyTuple_GET_ITEM(args, 2);
  int nRequestID = PyLong_AsLong(py_nRequestID);
  PyObject * ret = Py_BuildValue("i", user->ReqQryExchangeMarginRateAdjust(pQryExchangeMarginRateAdjust, nRequestID));
  free(pQryExchangeMarginRateAdjust);
  return ret;
}
...
static PyObject* Trader_ReqQueryCFMMCTradingAccountToken(PyObject * self, PyObject * args){
  CThostFtdcTraderApi * user = (CThostFtdcTraderApi *) PyLong_AsLong(PyTuple_GET_ITEM(args, 0));
  PyObject * py_pQueryCFMMCTradingAccountToken = PyTuple_GET_ITEM(args, 1);
  CThostFtdcQueryCFMMCTradingAccountTokenField* pQueryCFMMCTradingAccountToken = from_CThostFtdcQueryCFMMCTradingAccountTokenField(py_pQueryCFMMCTradingAccountToken);
  PyObject * py_nRequestID = PyTuple_GET_ITEM(args, 2);
  int nRequestID = PyLong_AsLong(py_nRequestID);
  PyObject * ret = Py_BuildValue("i", user->ReqQueryCFMMCTradingAccountToken(pQueryCFMMCTradingAccountToken, nRequestID));
  free(pQueryCFMMCTradingAccountToken);
  return ret;
}

static PyObject* Trader_RegisterFensUserInfo(PyObject * self, PyObject * args){
  CThostFtdcTraderApi * user = (CThostFtdcTraderApi *) PyLong_AsLong(PyTuple_GET_ITEM(args, 0));
...
static PyObject* Trader_ReqQrySecAgentACIDMap(PyObject * self, PyObject * args){
  CThostFtdcTraderApi * user = (CThostFtdcTraderApi *) PyLong_AsLong(PyTuple_GET_ITEM(args, 0));
  PyObject * py_pQrySecAgentACIDMap = PyTuple_GET_ITEM(args, 1);
  CThostFtdcQrySecAgentACIDMapField* pQrySecAgentACIDMap = from_CThostFtdcQrySecAgentACIDMapField(py_pQrySecAgentACIDMap);
  PyObject * py_nRequestID = PyTuple_GET_ITEM(args, 2);
  int nRequestID = PyLong_AsLong(py_nRequestID);
  PyObject * ret = Py_BuildValue("i", user->ReqQrySecAgentACIDMap(pQrySecAgentACIDMap, nRequestID));
  free(pQrySecAgentACIDMap);
  return ret;
}
...
PyMODINIT_FUNC PyInit__ctp_Trader()
{
   static PyMethodDef mbMethods[] = {
     ...
     {"ReqQryInvestorProductGroupMargin", Trader_ReqQryInvestorProductGroupMargin, METH_VARARGS} ,
     ...
     {"ReqQryExchangeRate", Trader_ReqQryExchangeRate, METH_VARARGS} ,
     ...
     {"ReqQryExchangeMarginRate", Trader_ReqQryExchangeMarginRate, METH_VARARGS} ,
     {"ReqQryProduct", Trader_ReqQryProduct, METH_VARARGS} ,
     ...
     {"ReqQryExchangeMarginRateAdjust", Trader_ReqQryExchangeMarginRateAdjust, METH_VARARGS} ,
     ...
     {"ReqQueryCFMMCTradingAccountToken", Trader_ReqQueryCFMMCTradingAccountToken, METH_VARARGS} ,
     {"RegisterFensUserInfo", Trader_RegisterFensUserInfo, METH_VARARGS} ,
     ...
     {"ReqQrySecAgentACIDMap", Trader_ReqQrySecAgentACIDMap, METH_VARARGS} ,
